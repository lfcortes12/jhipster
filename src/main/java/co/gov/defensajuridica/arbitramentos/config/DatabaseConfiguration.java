...
@Configuration
@EnableJpaRepositories("co.gov.defensajuridica.arbitramentos.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("co.gov.defensajuridica.arbitramentos.repository.search")
